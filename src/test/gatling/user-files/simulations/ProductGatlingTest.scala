...
class ProductGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Product entity")
        ...
        .repeat(2) {
            ...
            .post("/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "title":"SAMPLE_TEXT", "keywords":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "rating":"0", "dateAdded":"2020-01-01T00:00:00.000Z", "dateModified":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
